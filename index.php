...
<h2>Home</h2>
	...
	<div class="images">
		...
		<a href="#">
			<img src="<?=$image['filepath']?>"  data-id="<?=$image['id']?>" data-title="<?=$image['title']?>" width="300" height="200">
		...
		img.onload = () => {
			...
			image_popup.innerHTML = `
				<div class="con">
					...
					<p>${img_meta.alt}</p>
					<img src="${img.src}" style="width: 600px; height: 400px; object-fit: cover;">
					<a href="deleteImages.php?id=${img_meta.dataset.id}" class="trash" title="Delete Image"><i class="fas fa-trash fa-xs"></i></a>
				</div>
			`;
